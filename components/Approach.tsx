    ...
    <section className="w-full py-20" id="approach">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          descriprion="We'll collaborate to map out your website's goals, target audience, 
        ...
        <Card
          ...
          descriprion="Once we agree on the plan, I cue my lofi playlist and dive into
        ...
        <Card
          ...
          descriprion="This is where the magic happens! Based on the approved design, 
